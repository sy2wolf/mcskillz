...
scoreboard players set @s mcskillz.fishing_lvlup_pnt 0
...
scoreboard players set @s mcskillz.archery_lvlup_pnt 0
scoreboard players set @s mcskillz.magic_pnt 0
scoreboard players set @s mcskillz.magic_lvl 0
scoreboard players set @s mcskillz.magic_lvlup_pnt 0
scoreboard players set @s mcskillz.exploration_pnt 0
scoreboard players set @s mcskillz.exploration_lvl 0
scoreboard players set @s mcskillz.exploration_lvlup_pnt 0
scoreboard players set @s mcskillz.agility_pnt 0
scoreboard players set @s mcskillz.agility_lvl 0
scoreboard players set @s mcskillz.agility_lvlup_pnt 0
scoreboard players set @s mcskillz.endurance_pnt 0
scoreboard players set @s mcskillz.endurance_lvl 0
scoreboard players set @s mcskillz.endurance_lvlup_pnt 0
